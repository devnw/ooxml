...
func (m *CT_HeaderFooter) MarshalXML(e *xml.Encoder, start xml.StartElement) error {
	...
	if m.FirstHeader != nil {
		...
		office.AddPreserveSpaceAttr(&sefirstHeader, *m.FirstHeader)
	...
	if m.FirstFooter != nil {
		...
		office.AddPreserveSpaceAttr(&sefirstFooter, *m.FirstFooter)
...
lCT_HeaderFooter:
	for {
		...
		case xml.StartElement:
			...
			default:
				office.Log("skipping unsupported element on CT_HeaderFooter %v", el.Name)
